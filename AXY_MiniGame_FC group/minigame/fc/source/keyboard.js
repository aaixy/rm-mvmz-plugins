...
JSNES.Keyboard.prototype = {
    setKey: function (key, value) {
        switch (key) {
            ...
            case 'AA':
                this.state1[this.keys.KEY_A] = 0x81 - this.state1[this.keys.KEY_A];
                break; // AA
                //case 83: this.state1[this.keys.KEY_A] = 0x81 - this.state1[this.keys.KEY_A]; break;  // AA
            case 78:
                this.state1[this.keys.KEY_A] = 0x81 - this.state1[this.keys.KEY_A];
                break; // N
            case 'BB':
                this.state1[this.keys.KEY_B] = 0x81 - this.state1[this.keys.KEY_B];
                break; // BB
                //case 65: this.state1[this.keys.KEY_B] = 0x81 - this.state1[this.keys.KEY_B]; break;  // BB
            case 66:
                this.state1[this.keys.KEY_B] = 0x81 - this.state1[this.keys.KEY_B];
                break; // B
            ...
            case 111:
                this.state2[this.keys.KEY_A] = 0x81 - this.state2[this.keys.KEY_A];
                break; // AA
            case 106:
                this.state2[this.keys.KEY_B] = 0x81 - this.state2[this.keys.KEY_B];
                break; // BB

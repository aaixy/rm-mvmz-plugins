...
Scene_SlotMachine.prototype.createInstruction = function () {
    this._instructionWindow = new Window_SlotInstruction(0+offsetx, 0, Graphics.boxWidth, 26 * 6 + 18 * 2);
...
Scene_SlotMachine.prototype.createSlotMachine = function () {
    this._slotMachineWindow = new Window_SlotMachine(0+offsetx, this._instructionWindow.height, Graphics.boxWidth, 200);
...
Scene_SlotMachine.prototype.result = function () {
    ...
    if (this._winCoin > 0) {
        ...
        AudioManager.playMe({"name": "megotbuddy", "volume": 90, "pitch": 100, "pan": 0});
    }
    else {
